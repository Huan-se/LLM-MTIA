...
def main():
    ...
    # 锁定私有验证集
    parser.add_argument("--dataset_path", type=str, default="./datasets/Magicoder-OSS-Instruct")
    ...
    predictions, references, results_cache = [], [], []
    ...
    for example in tqdm(test_dataset):
        ...
        if args.output_json:
            results_cache.append({
                "instruction": instruction_text, "raw_generated": raw_generated_text, "pure_extracted_code": pure_code
            })
    ...
    print(f"=== 总分: {result['codebleu'] * 100:.2f} ===")
    print("="*40 + "\n")
